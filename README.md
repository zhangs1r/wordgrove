...
| 版本 | 内容 |
|------|------|
| v0.32 | **言木小院（正反馈农场）**：今日页升级为小院（Canvas 320×224 程序化像素：房屋/草地/耕地/池塘/天气）；**木果+成长值奖励**（查词新词 2/2·对话 24 词档 3/6·剧场有效回合 3/6·复盘 8-10/16-20·采纳表达 2/4·有效时长每3分钟+1；统一 RewardService：幂等键+日上限80+单事务防重复）；3 作物（萝卜/蓝莓/南瓜）+2 树+7 装饰+4→10 地块+家园等级 1-8+收获图鉴；商店/背包/放置/收获/移除；IndexedDB v2 farm store；导出导入含农场；开垦包 32 木果+纪念牌 |
